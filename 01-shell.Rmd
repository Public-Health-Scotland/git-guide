...
| Navigating Files & Directories  | Description |
|:---|:---|
| `cd [path]` | Changes the current working directory to the specified path |
| `ls [path]` | Prints a listing of the specified file or directory. (If `ls` is used alone, the current working directory will be listed.) |
| | |
