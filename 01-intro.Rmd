...
3. **Create an SSH Key** - this step is recommended for users who will be using a remote such as GitHub with their project. The other option is HTTPS (which doesn't require setup), however SSH is a faster, more secure, and more convienent method of connecting to GitHub.
